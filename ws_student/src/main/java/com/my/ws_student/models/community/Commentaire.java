...
public class Commentaire extends ObjectBDD {
    ...
    @KeyAnnotation
    private Timestamp DateCommentaire=new Timestamp(System.currentTimeMillis());
    @KeyAnnotation
...
//    }
    ...
    private ArrayList<FichierPartager> list_fileComs = null;

    public ArrayList<FichierPartager> getList_fileComs() throws Exception {
        if (list_fileComs == null) {
            list_fileComs = new FichierPartager().SelectAllByCommentaire(getIdCommentaire());
        }
        return list_fileComs;
    }

    public void setList_fileComs(ArrayList<FichierPartager> list_fileComs) {
        this.list_fileComs = list_fileComs;
    }
